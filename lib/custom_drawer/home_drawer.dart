...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setdDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        index: DrawerIndex.Wishlist,
        labelName: 'My Wishlist',
        icon: Icon(Icons.favorite),
      ),
      DrawerList(
        index: DrawerIndex.Notifications,
        labelName: 'My Notifications',
                ...
                children: <Widget>[
                  ...
                  listData.isAssetsImage
                      ? Container(
                          width: 24,
                          height: 24,
                          child: Image.asset(listData.imageName, color: widget.screenIndex == listData.index ? Colors.green : AppTheme.nearlyBlack),
                        )
                      : Icon(listData.icon.icon, color: widget.screenIndex == listData.index ? Colors.green : AppTheme.nearlyBlack),
                  const Padding(
                    padding: EdgeInsets.all(4.0),
                  ),
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize: 16,
                      color: widget.screenIndex == listData.index ? Colors.green : AppTheme.nearlyBlack,
                    ),
                    textAlign: TextAlign.left,
                  ),
                ],
